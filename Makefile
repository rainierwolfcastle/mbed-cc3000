...
GCC_BIN =
PROJECT = mbed_cc3000
OBJECTS = ./main.o ./cc3000_host_driver/cc3000_common.o ./cc3000_host_driver/evnt_handler.o ./cc3000_host_driver/hci.o ./cc3000_host_driver/netapp.o ./cc3000_host_driver/nvmem.o ./cc3000_host_driver/security.o ./cc3000_host_driver/socket.o ./cc3000_host_driver/wlan.o ./ccspi.o ./board.o
...
CC_SYMBOLS = -DTARGET_KL25Z -DTARGET_M0P -DTARGET_Freescale -DTARGET_KLXX -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -D__CORTEX_M0PLUS -DARM_MATH_CM0PLUS -DMBED_BUILD_TIMESTAMP=1399122867.36 -D__MBED__=1 -DTARGET_FF_ARDUINO 
